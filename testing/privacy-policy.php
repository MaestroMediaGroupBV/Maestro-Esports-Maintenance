...
<head>
        ...
        <title>Maestro Esports | Privacy Policy</title>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title">You are currently viewing the English (U.K.) version of the site</h5>
      </div>
      <div class="modal-body">
	  <center>
        <p>you can stay on the uk site by clicking the English, (U.K.) Flag or proceed to the Dutch transaltion of the site by clicking the Dutch, (Netherlands) Flag</p><br>
						<a href="privacy-policy"><img src="assets/img/flags/uk.png"></a>&nbsp;
						<a href="nl/privacy-policy"><img src="assets/img/flags/nl.png"></a>
	  </center>
      </div>
		...
		<div id="side-bar">
			<div class="inner-wrapper">
              ...
              <li class="menu-item"><a href ="https://dombaishop.com/collections/maestro" target="_blank" >Shop</a>
						...
						<br>
						<div class="col-md-6">
						<p class="bordered allcaps"><font color="#818181">Languages</font></p>
						</div>
						<div class="col-md-6">
						<a href="#language" data-toggle="modal"><img src="assets/img/flags/uk.png" width="35" height="23" ></a>&nbsp;
						<a href="#language" data-toggle="modal"><img src="assets/img/flags/nl.png" width="35" height="23" ></a>
						</div>
						</div>
		...
		<div id="main-content">
			<div class="page-wrapper regular-page">
				<div class="container">
					...
					<ol class="breadcrumb">
						<li><a href="https://masesports.org">Home</a></li>
					...
					<p>When ordering or registering on our site, as appropriate, you may be asked to enter your name, email address, IP Address or other details to help you with your experience.</p>

					<h2>When do we collect information?</h2>
					<p>We collect information from you when you register on our site, place an order, respond to a survey, fill out a form, Use Live Chat, Open a Support Ticket or enter information on our site.</p>
      ...
      <li>To personalize your experience and to allow us to deliver the type of content and product offerings in which you are most interested.
       ...
       <li>To follow up with them after correspondence (live chat, email or phone inquiries)</li><br>
					...
					We use regular Malware Scanning.<br></p>
		...
		<li>Help remember and process the items in the shopping cart.
		<li>Understand and save user's preferences for future visits.
		<li>Keep track of advertisements.
		<li>Compile aggregate data about site traffic and site interactions in order to offer better site experiences and tools in the future. We may also use trusted third-party services that track this information on our behalf.</li><br>
      ...
      <li> Google Display Network Impression Reporting
      <li> Demographics and Interests Reporting
      <li> DoubleClick Platform Integration</li><br>
...
<p>Can change your personal information:</p>
      ...
      <li> By chatting with us or by sending us a support ticket</li>
					...
					<p>In order to remove your child's information please contact the following personnel:
...
<p>We will notify the users via in-site notification</p>
      ...
      <li> Send you additional information related to your product and/or service</li>
					...
					<p>If at any time you would like to unsubscribe from receiving future emails, you can email us at contact@masesports.org
and we will promptly remove you from ALL correspondence.</p>

					<h2>Contacting Us</h2>
					<p>If there are any questions regarding this privacy policy, you may contact us using the information below.</p>

<p>contact@masesports.org</p>
<p>(+31) 641-716-201</p>

<p>Last Edited on 2017-06-18</p>
				</div>
			</div>
		</div>
		<!-- Page main wrapper -->
