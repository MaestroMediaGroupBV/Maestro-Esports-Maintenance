...
<head>
        ...
        <title>Maestro eSports | Contact</title>
		...
		<div id="side-bar">
			<div class="inner-wrapper">
              ...
              <li class="menu-item"><a href ="https://dombaishop.com/collections/maestro" target="_blank" >Shop</a>
							...
							<li class="menu-item current-menu-parent"><a href="contact.php">Contact</a>
							</li>
        ...
        <!--Page sidebar-->
            <div class="page-side set-bg inview-animate inview-fadeleft">
				<img src="assets/img/Home/1.png" alt="alt" class="img-responsive">
				    ...
				    <p>Need to get in contact with us? You can use the information below to do so.</p>
				</div>
						</div>
					</div>
            </div>
				...
				<div class="row">
					<div class="col-sm-4 col-xs-12">
							<div class="contact-detail">
								...
								The, Netherlands
								<br>
								Cornelis van UItgeeststraat 1a
								<br>
								1508EG, Zaandam
							</div>
							...
							<div class="contact-detail">
								...
								<ul class="list-iconed">
									<li>
										<i class="fa fa-envelope"></i>E: contact@masesports.org
									</li>
									<li>
										<i class="fa fa-phone"></i> T: (+31) 641-716-201
									</li>
<!-- 									<li>
										<i class="fa fa-phone"></i> T: (+31) 641-716-201
									</li> -->
							...
							<div class="contact-detail">
								<h5>Partnership & Advertising</h5>
								<hr>
								<ul class="list-iconed">
									<li>
										<i class="fa fa-envelope"></i>E: partners@masesports.org
									</li>
									<li>
										<i class="fa fa-phone"></i> T: (+48) 695-447-238
									</li>
				...
				<!-- Main Content -->
				<div class="page-main">
					<div id="gmap" class="gmap-full" data-address="Cornelis van UItgeeststraat 1a1508EG, Zaandam"></div>
				</div>
				<!-- /Main Content -->
		...
		<!-- google map -->
		<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCmaDencDtGDgLtHIh8T2YcHG7hzV72vn4&callback=initMap"></script>
