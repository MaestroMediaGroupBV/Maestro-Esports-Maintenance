...
<head>
        ...
        <title>Maestro eSports | Partners</title>
...
<!-- End of Async Drift Code -->
				...
				<div id="side-inner">
					...
					<div id="side-contents">
						...
						<ul id="navigation">
							...
							<li class="menu-item current-menu-parent"><a href="partners.php">Partners</a>
							</li>
        ...
        <!--Page sidebar-->
				<div class="page-side set-bg inview-animate inview-fadeleft">
                    <img src="assets/img/Home/1.png" alt="alt" class="img-responsive">
    ...
    <div class="fullwidth-section text-light align-center" style="background-color:#333333;">
        <div class="container">
            <div class="row">
                <div class="team-members">
                    <div class="col-md-4 col-xs-12">
                        <div class="team-item partners">
                            <div class="team-head">
                            <div class="team-head-img">
                                <img src="assets/img/twitch-api/streamers/masesports.jpg" alt="alt" class="img-responsive">
                            </div>
                            <hr class="hr-thing-grey">
                            <div class="team-content">
                                <div class="title partners">VR Gamehouse</div>
                                <div class="descrip">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</div>
                                <ul class="team-socials partners">
                                    <li><a href="https://www.twitch.tv/exqlusiv_" target="_blank"><i class="fa fa-twitch"></i></a></li>
                                    <li><a href="https://twitter.com/exQlusivCSGO" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="https://www.instagram.com/servranckxlien/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                </ul>
                            </div>
                            </div>
                        </div>

                        <div class="expand col-md-12 col-xs-12">
                        <h5 class="title work">
                            Want to work together?
                        </h5>
                        <div class="col-md-12 col-xs-12 button-ctn">
                            <a class="btn btn-work" href="contact">Contact Us</a>
                        </div>
                    </div>
